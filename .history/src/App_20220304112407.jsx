      ...
      <Navbar className="navbar py-4" bg="white" expand="lg">
        <Container className="w-75 m-auto">
          <Link className="link" to="/">
            <Navbar.Brand onClick={updateTheme("https://newsapi.org/v2/everything?q=football&apiKey=9ccd6ff9d04943049e448525cd92bd14")} className="px-3">Latest News</Navbar.Brand>
          </Link>
