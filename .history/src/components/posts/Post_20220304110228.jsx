      ...
      <section className="section justify-content-between m-auto pt-5">
        {News && props.Photos ? (
          <article className="post">
            <img className="post__image" src={News.articles[id].urlToImage} alt="" />
            <div className="post__title">{News.articles[id].title}</div>
            <div className="post__body post__body--uppercase">{News.articles[id].description}</div>
          </article>
        ) : (
